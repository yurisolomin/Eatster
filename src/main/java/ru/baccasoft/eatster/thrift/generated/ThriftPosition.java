...
public class ThriftPosition implements org.apache.thrift.TBase<ThriftPosition, ThriftPosition._Fields>, java.io.Serializable, Cloneable, Comparable<ThriftPosition> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ThriftPosition");
  ...
  static {
    schemes.put(StandardScheme.class, new ThriftPositionStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ThriftPositionTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ThriftPosition.class, metaDataMap);
  }

  public ThriftPosition() {
  }
   ...
   */
  public ThriftPosition(ThriftPosition other) {
    __isset_bitfield = other.__isset_bitfield;
    this.latitude = other.latitude;
    this.longitude = other.longitude;
  }

  public ThriftPosition deepCopy() {
    return new ThriftPosition(this);
  }
  ...
  public ThriftPosition setLatitude(double latitude) {
    this.latitude = latitude;
    setLatitudeIsSet(true);
    return this;
  }
  ...
  public ThriftPosition setLongitude(double longitude) {
    this.longitude = longitude;
    setLongitudeIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ThriftPosition)
      return this.equals((ThriftPosition)that);
    return false;
  }

  public boolean equals(ThriftPosition that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(ThriftPosition other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ThriftPosition(");
    boolean first = true;
  ...
  private static class ThriftPositionStandardSchemeFactory implements SchemeFactory {
    public ThriftPositionStandardScheme getScheme() {
      return new ThriftPositionStandardScheme();
    }
  }

  private static class ThriftPositionStandardScheme extends StandardScheme<ThriftPosition> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ThriftPosition struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ThriftPosition struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class ThriftPositionTupleSchemeFactory implements SchemeFactory {
    public ThriftPositionTupleScheme getScheme() {
      return new ThriftPositionTupleScheme();
    }
  }

  private static class ThriftPositionTupleScheme extends TupleScheme<ThriftPosition> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ThriftPosition struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ThriftPosition struct) throws org.apache.thrift.TException {
